  ...
  return (
    <main className="bg-green-100 min-h-screen p-12">
      <section className="container mx-auto">
        ...
        <h2 className="text-lg text-gray-600 flex justify-center mb-12 pl-4">
              ...
              <article>
                <Link to={'/post/' + post.slug.current} key={post.slug.current}>
                  ...
                  >
                    ...
                    />
                    <span className="block relative h-full flex justify-center lg:justify-end items-end pr-4 pb-4">
